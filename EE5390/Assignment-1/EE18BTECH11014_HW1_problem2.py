...
SC = ShannonCode() 
SC.CompressFile("inputfile_problem2_18.txt", "OutputFile-2c-Shannon.bin")
SC.ReadCompressedFile("inputfile_problem2_18.txt", "OutputFile-2c-Shannon.bin")
print ("\n")

print ("Compressing and Reading Data using Huffman Code")
HC = HuffmanCode()
HC.CompressFile("inputfile_problem2_18.txt", "OutputFile-2c-Huffman.bin")
HC.ReadCompressedFile("inputfile_problem2_18.txt", "OutputFile-2c-Huffman.bin")
print ("\n")

print ("Compressing and Reading Data using Shannon-Fano-Elias Code")
SFEC = SFECode()
SFEC.CompressFile("inputfile_problem2_18.txt", "OutputFile-2c-SFE.bin")
SFEC.ReadCompressedFile("inputfile_problem2_18.txt", "OutputFile-2c-SFE.bin")
