...
plt.title("Analog Low Pass Filter")
plt.savefig("../../figs/IIR_AnalogLowPass.eps")
plt.show()
...
plt.xlabel(r'$\Omega$')
plt.ylabel(r'$|H_{a,BP}(j\Omega)|$')
plt.title("Analog Band Pass Filter")
plt.savefig("../../figs/IIR_AnalogBandPass.eps")
plt.show()
...
plt.savefig("../../figs/IIR_DigitalBandPass.eps")
plt.show()
iir_num = G*dignum
iir_den = digden
