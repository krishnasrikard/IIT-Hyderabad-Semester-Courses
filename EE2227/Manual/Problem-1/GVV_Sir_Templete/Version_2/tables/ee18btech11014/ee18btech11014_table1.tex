...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$G_1$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$60 dB$}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$G_2$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$20dB$}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$G_3$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$20dB$}
\\
\hhline{|--|}
...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$\frac{1}{2\pi}nF$}
