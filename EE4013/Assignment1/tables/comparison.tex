...
\hhline{|-----|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}$1.212$}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}$8$}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}$0.651$}
\\
\hhline{|-----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}$14$}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}$0.887$}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}$7$}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}$0.504$}
\\
\hhline{|-----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}$0.886$}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}$6$}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}$0.517$}
\\
\hhline{|-----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}$18$}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}$0.708$}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}$9$}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}$0.643$}
\\
\hhline{|-----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}$1.299$}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}$6$}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}$0.397$}
\\
\hhline{|-|-|-|-|-}
\end{tabular}
