...
\section{Solution}
\subsection{Answer}
\textbf{SomeFunction} is calculates GCD of positive integers $x$ and  $y$. The Algorithm used in it is Euclidean Algorithm by Subtraction.
\begin{align}
...
\quad Worst Case Time-Complexity of Euclidean Algorithm by Subtraction is $\mathcal{O}(\log min(a,b))$.\\
